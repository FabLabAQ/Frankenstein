//!AGG:G131231
//AGG:G131203
#define MOD3DPRN_FIRMWARE_VER 1.5
...
#define STRING_CONFIG_H_AUTHOR "(Luca Anastasio, FabLabAQ)" // Who made the changes.
...
#define BED_MINTEMP 5//!AGG:G131231 era 5. impostato a 0 per considerare la possibilità del termistore non collegato
...
//AGG:G140901 #define HOMING_FEEDRATE {50*60, 50*60, 10*60, 0}  // set the homing speeds (mm/min)
#define HOMING_FEEDRATE {80*60, 80*60, 60*60, 0}  // set the homing speeds (mm/min)
